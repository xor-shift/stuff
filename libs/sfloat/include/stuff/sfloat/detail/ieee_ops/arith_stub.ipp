...
template<concepts::ieee_float_description Desc>
constexpr auto add(soft_float<Desc> lhs, soft_float<Desc> rhs, fenv&& env = fenv()) -> soft_float<Desc> {
    return detail::stub_arith_impl(lhs, rhs, std::move(env), std::plus<>{});
}

template<concepts::ieee_float_description Desc>
constexpr auto sub(soft_float<Desc> lhs, soft_float<Desc> rhs, fenv&& env = fenv()) -> soft_float<Desc> {
    return detail::stub_arith_impl(lhs, rhs, std::move(env), std::minus<>{});
}

template<concepts::ieee_float_description Desc>
constexpr auto mul(soft_float<Desc> lhs, soft_float<Desc> rhs, fenv&& env = fenv()) -> soft_float<Desc> {
    return detail::stub_arith_impl(lhs, rhs, std::move(env), std::multiplies<>{});
}

template<concepts::ieee_float_description Desc>
constexpr auto div(soft_float<Desc> lhs, soft_float<Desc> rhs, fenv&& env = fenv()) -> soft_float<Desc> {
    return detail::stub_arith_impl(lhs, rhs, std::move(env), std::divides<>{});
}
